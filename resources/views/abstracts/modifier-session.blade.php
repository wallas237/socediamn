<x-app-layout>
    <div class="container d-flex justify-content-center">
        <div class="card shadow mb-4 w-50">
            ...
            @php
                $v = DB::table('communication_salles')->where('id', $id)->first();
            @endphp
            <div class="card-body">
                <section>
                    ...
                    <form method="post" action="{{ route('update.session', ['id' => $id]) }}" class="mt-6 space-y-6">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-sm-12">
                                ...
                                <x-text-input id="date_heure" name="date_heure" type="datetime-local"
                                    class="form-control bg-white  text-dark" :value="old('date_heure', $v->date_heure)" required autofocus
                            ...
                            <div class="col-xl-6 col-sm-12">
                                ...
                                <x-text-input id="date_fin" name="date_fin" type="datetime-local"
                                    class="form-control bg-white  text-dark" :value="old('date_fin', $v->date_fin)" required autofocus
                         ...
                         <div class="pt-3">
                            ...
                            <x-text-input id="type_name" name="type_name" type="text"
                                class="form-control bg-white block text-dark" :value="old('type_name', $v->type)" autofocus
                        ...
                        <div class="pt-3">
                            ...
                            <textarea name="libelle_session" id="" cols="40" rows="15"
                                class="form-control bg-white block text-dark">{{ old('libelle_session', $v->libelle_session) }}</textarea>
                        </div>
                        <div class="pt-3">
                            ...
                            <x-text-input id="moderateur" name="moderateur" type="text"
                                class="form-control bg-white block text-dark" :value="old('moderateur', $v->moderateur)" autofocus
