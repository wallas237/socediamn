                        ...
                        <form method="post" action="{{ route('update.session', ['id'=>$id]) }}" class="mt-6 space-y-6">
                            ...
                            <div class="p-3">
                                ...
                                <x-text-input id="date_heure" name="date_heure" type="datetime-local" class="form-control bg-white  text-dark"
                                    :value="old('date_heure', $v->date_heure)" required autofocus autocomplete="date_heure" />
                            ...
                            <div class="p-3">
                                ...
                                <x-text-input id="libelle_salle" name="libelle_salle" type="text" class="form-control bg-white block text-dark"
                                    :value="old('libelle_salle', $v->libelle_salle)" autofocus autocomplete="libelle_salle" />
                            ...
                            <div class="p-3">
                                ...
                                <textarea name="libelle_session" id="" cols="40" rows="15" class="form-control bg-white block text-dark">{{ $v->libelle_session }}</textarea>
