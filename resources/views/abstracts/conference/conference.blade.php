        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h6 class="m-0 font-weight-bold text-black-50">Liste des conférences non validées</h6>
                    <button class="btn btn-success">
                        <a href="/excel-abstract-export" class="text-white text-decoration-none">Exporter les abstracts
                            sur Excel</a>
                    </button>
                     <button class="btn btn-warning">
                        <a href="/send-conference-all-certificate" class="text-white text-decoration-none">Envoyez Attestation de conférence</a>
                    </button>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @php
                                $abstracts = DB::table('abstracts')
                                    ->where('type_abstract', 'Conférence')
                                    ->where('confirmation_abstract', 0)
                                    ->get();
                            @endphp
