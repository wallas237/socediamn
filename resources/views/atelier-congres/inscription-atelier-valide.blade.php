        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h6 class="m-0 font-weight-bold text-black-50">Liste des inscriptions validées </h6>
                    <button class="btn btn-success">
                        <a href="/send-all-atelier-certificate" class="text-white text-decoration-none">Envoyez Attestation participation</a>
                    </button>
                </div>

            </div>
            @php
                $participantInscriptions = DB::table('inscriptions')
                    ->where('atelier_pre_1', 'Oui')
                    ->orWhere('atelier_pre_2', 'Oui')
                    ->get();
            @endphp
            <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton7">
                                                ...
                                                <a href="/send-atelier-congres-participation/{{ $v->id }}"
                                                    class="dropdown-item"
                                                    onclick="return confirm('Cliquer sur ok pour confirmer cet envoi')"><button
                                                        class="btn btn-warning p-2">
                                                        <i
                                                            class="mdi mdi-email-outline"></i>{{  "Envoyez attestation"}}</button></a>
                                                </a>
