        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h6 class="m-0 font-weight-bold text-black-50">Liste des participants inscrits n'ayant pas de badge
                    </h6>
                    <button class="btn btn-success">
                        <a href="/badge-participant" class="text-white" target="_blank">Imp. Badge</a>
                    </button>
                </div>
                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Lieu de service</th>
                        ...
                        <tbody>
                            @php
                                $inscript = DB::table('inscriptions')
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton7">
                                                ...
                                                {{-- <a class="dropdown-item" href="/certificat-participation/{{ $v->id }}"
