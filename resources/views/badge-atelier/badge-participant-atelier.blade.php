...
<body>
 ...
 $to = [0, 255, 255];*/
        ...
        $i = 1;
        $compteurDiv = 0;
        $imageBadge = 'assets/images/badges/atelier.png';
    @endphp
    <div class="container">
        ...
        @foreach ($data['participants'] as $participant)
            ...
            @if ($i == 1)
                <div style="margin-top: {{ '-6%;' }} position: absolute; margin-left: {{ '-5.5%' }}"
                    ...
                    @if ($participant->atelier_pre_1 == 'Oui' && $participant->atelier_pre_2 == 'Oui')
                        <div class="titre-atelier" style="top: 15%; left: 1.5%;">
                            <h4>Atelier Payant <br>  Echographie Thoracique <br> & <br>  Spirometrie </h4>

                        </div>
                    @else
                        <div class="titre-atelier-2" style="top: 15%; left: 2%;">
                            <h4>Atelier Payant <br>{{ $participant->atelier_pre_1 == 'Oui' ? "ECHOGRAPHIE THORACIQUE" :  "SPIROMETRIE" }}</h4>
                        </div>
                    @endif
                    @php
                    ...
                    <p style="top: 66%; font-size: 1.5em; color: #3a83c7;  font-weight:  500;">{{ $libelle }}
                    </p>
                    <h2 style="top: 75%;">{{ $ville }}</h2>
                    {{-- <h2 style="top: 79%; position: absolute; font-weight: bolder; color:aliceblue; font-size: 1.7em;" >{{ $libelle }} </h2> --}}
                    <div class="qr-code" style="top: 23%; right: 20%; border: 1px solid rgb(6, 6, 59);">
            ...
            @elseif($i == 2)
                <div style=" position: absolute; top: -4%; right: -4.5%;" class="{{ $i }}">
                    <img src="{{ $imageBadge }}" alt="" class="badge-item" id="badge">
                     @if ($participant->atelier_pre_1 == 'Oui' && $participant->atelier_pre_2 == 'Oui')
                        <div class="titre-atelier" style="top: 10%; left: 1.5%;">
                            <h4>Atelier Payant <br>  Echographie Thoracique <br> & <br>  Spirometrie </h4>

                        </div>
                    @else
                        <div class="titre-atelier-2" style="top: 10%; left: 2%;">
                            <h4>Atelier Payant <br>{{ $participant->atelier_pre_1 == 'Oui' ? "ECHOGRAPHIE THORACIQUE" :  "SPIROMETRIE" }}</h4>
                        </div>
                    @endif
                    @php
                    ...
                    <p style="top: 63%; font-size: 1.5em; color: #3a83c7;  font-weight:  500;">{{ $libelle }}
                    </p>
