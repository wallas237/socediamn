        ...
        @foreach ($participants as $participant)
            ...
            @if ($i == 1)
                <div style="margin-top: {{ '-6%;' }} position: absolute; margin-left: {{ '-5.5%' }}"
                    ...
                    <h2 style="top: 70%;">{{ $ville }}</h2>
                    <h2
                        style="top: 77%; position: absolute; font-weight: bolder; color: whitesmoke !important; font-size: 1.7em;">
                        {{ $libelle }} </h2>
            ...
            @elseif($i == 2)
                <div style=" position: absolute; top: -4%; right: -4.5%;" class="{{ $i }}">
                    ...
                    {{-- <p style="top: 63%; font-size: 1.5em; color: whitesmoke;">{{ $grade }}</p> --}}
                    <h2 style="top: 67%;">{{ $ville }}</h2>
                    <h2
                        style="top: 74%; position: absolute; font-weight: bolder; color: whitesmoke !important; font-size: 1.7em;">
                        {{ $libelle }} </h2>
