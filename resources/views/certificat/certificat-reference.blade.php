...
<body>
    ...
    @foreach ($arrayTitre as $libelle)
        ...
        @if (strlen($abstract->titre) <= 160)
            ...
            @else
                ...
                @endphp
            @endif
        @elseif(strlen($abstract->titre) >= 160 && strlen($abstract->titre) <= 180)
        ...
        @endphp
        @if (strlen($abstract->titre) <= 120)
            @if (strlen($verifyLength1) <= 120)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
            @endif
        @elseif(strlen($abstract->titre) >= 121 && strlen($abstract->titre) <= 240)
            @if (strlen($verifyLength1) <= 120)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
    ...
    @elseif(strlen($abstract->titre) >= 241 && strlen($abstract->titre) <= 361)
    ...
    <div class="bg-certificate">
        @if ( strlen($abstract->titre) <= 120)
            <img src="assets/images/attestation/congres/conference-min.png" alt="" id="bg">
        @else
            <img src="assets/images/attestation/congres/conference-max.png" alt="" id="bg">
        @endif
    </div>
</body>
