                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    @if ($data['atelier_pre_1'] == 'Oui' && $data['atelier_pre_2'] == 'Oui')


                                        <h3>Votre inscription aux atéliers <strong> Echographie thoracique qui aura
                                                lieu le 30/07/2025 de
                                                08h-12h</strong> et <strong> Spirométrie qui aura lieu le 30/07/2025 de
                                                08h-12h</strong> du pré congrès qui auront lieu le 30/07/2025 a bien été
                                            validée
                                        </h3>


                                    @elseif($data['atelier_pre_1'] == 'Oui' && $data['atelier_pre_2'] == 'Non')

                                        <h3>Votre inscription à l'atélier <strong> Echographie thoracique qui aura
                                                lieu le 30/07/2025 de
                                                08h-12h</strong> a bien été validée</h3>

                                    @elseif($data['atelier_pre_2'] == 'Oui' && $data['atelier_pre_1'] == 'Non')

                                        <h3>Votre inscription à l'atélier <strong>Spirométrie qui aura lieu le
                                                30/07/2025 de
                                                08h-12h</strong> a bien été validée</h3>
                                ...
                                {{-- <p
                                    ...
                                    {{ "Toutefois si vous souhaitez avoir une lettre d'invitation" }} <a
                                        href="https://dashboard.scpneumologie.com/lettre-invitation/{{ $data['id'] }}">Cliquez
                                        ici</a>
                                </p> --}}
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
