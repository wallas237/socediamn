            ...
            <td>
                <div class="container">
                    ...
                    <div class="content">
                       ...
                       <br>
                       <br>
                       {{ "a été accepté en poster sous réserve de modifications à apporter au plutard le 30 Octobre prochain" }}
                       <br> 
                       {{ "Des informations détaillées sur les caractéristiques de votre poster vous seront communiquées dans un mail ultérieurement." }}
                       <br>
