                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    {{ 'Nous avons le plaisir de vous informer que votre conference intitulé :' }}
                                    <br>
                                    <strong>
                                        {{ $data->titre }}
                                    </strong>
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    {{ 'a été accepté au 5' }}<sup>ème</sup> Congrès de la
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
{{--                                     {{ 'Des informations détaillées sur la date et heure de présentation vous seront communiquées dans un mail ultérieurement.' }}
 --}}                                    <br>
                                    <br>
                                    Cordialement
                                </p>
