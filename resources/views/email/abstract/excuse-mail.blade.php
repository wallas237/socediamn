                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <h3>Chèr(e) Collègue </h3>
                                </p>
                                <p>
                                    Une erreur s'est glissée dans les mails que vous avez reçus, au sujet de la décision
                                    concernant les résumés soumis en vue d'une communication au prochain congrès
                                    conjoint SAPLF/SCP.
                                </p>
                                <p>
                                    Nous vous prions de bien vouloir ignorer ces mails, et nous excusons pour la
                                    confusion créée.
                                    <br>
                                    Vous recevrez dans quelques instants de nouveaux mails précisant les décisions réelles et les consignes y relatives.
                                </p>
