                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    {{ 'a été acceptée en communication orale au 5' }}
                                    <sup>ème</sup> Congrès de la
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                   {{--  {{ "Sauf modification contraire, votre communication sera présentée le $com->date, dans la plage horaire $com->heure dans la salle $com->salle par l’un des auteurs. Votre temps de parole est de six (6) minutes, suivi de trois (3) minutes de questions - réponses.
                                    Par ailleurs, veuillez trouver ci-joint le modèle de masque powerpoint de présentation proposé par les organisateurs." }} <br>
                                    <a href="https://dashboard.scpneumologie.com/masque_de_presentation_CAPLF_SCP_2025.pptx" download="masque_de_presentation_CAPLF_SCP_2025.pptx">Cliquez ici pour récupérer le modèle</a> --}}
