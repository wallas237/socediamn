...
<body>
    ...
    <div class="bg-certificate">
        @if ( strlen($service->libelle) <= 120)
            <img src="assets/images/attestation/congres/rapporte-plenier-min.png" alt="" id="bg">
        @else
            <img src="assets/images/attestation/congres/rapporte-plenier-max.png" alt="" id="bg">
        @endif
    </div>
</body>
