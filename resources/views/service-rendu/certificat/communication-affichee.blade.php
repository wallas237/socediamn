...
<body>
    @php
        $titre = ucfirst(mb_strtolower($service->libelle));
    ...
    @foreach ($arrayTitre as $libelle)
        ...
        @if (strlen($service->libelle) <= 160)
            ...
            @else
                ...
                @endphp
            @endif
        @elseif(strlen($service->libelle) >= 160 && strlen($service->libelle) <= 180)
        ...
        @endphp
        @if (strlen($service->libelle) <= 80)
            @if (strlen($verifyLength1) <= 80)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
            @endif
        @elseif(strlen($service->libelle) >= 81 && strlen($service->libelle) <= 150)
            @if (strlen($verifyLength1) <= 80)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
        ...
        @endif
    @endforeach
    <h2 class="name">{{ $inscription->titre . ' ' . mb_strtoupper($inscription->name) . ' ' . $inscription->prenom }}
    </h2>
    @if (strlen($service->libelle) <= 80)
    ...
    @elseif(strlen($service->libelle) >= 241 && strlen($service->libelle) <= 361)
        <h5 class="titre-7">{{ $libelleTitre1 . ' ' . strlen($service->libelle) }}</h5>
    ...
    <div class="bg-certificate">
        @if ( strlen($service->libelle) <= 80)
            <img src="assets/images/attestation/congres/modere-com-affichee-min.png" alt="" id="bg">
        @else
            <img src="assets/images/attestation/congres/modere-com-affichee-max.png" alt="" id="bg">
        @endif
    </div>
</body>
