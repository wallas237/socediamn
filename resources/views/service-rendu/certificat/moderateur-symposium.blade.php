...
<body>
    ...
    <div class="bg-certificate">
        @if ( strlen($service->libelle) <= 120)
            <img src="assets/images/attestation/congres/modere-symposium-min.png" alt="" id="bg">
        @else
            <img src="assets/images/attestation/congres/modere-symposium-max.png" alt="" id="bg">
        @endif
    </div>
</body>
