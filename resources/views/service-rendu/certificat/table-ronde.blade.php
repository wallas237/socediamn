...
<body>
    ...
    @foreach ($arrayTitre as $libelle)
        ...
        @endphp
        @if (strlen($service->libelle) <= 120)
            @if (strlen($verifyLength1) <= 120)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
            @endif
        @elseif(strlen($service->libelle) >= 121 && strlen($service->libelle) <= 240)
            @if (strlen($verifyLength1) <= 120)
                @php
                    $libelleTitre1 .= $libelle . ' ';
                @endphp
    ...
    @if (strlen($service->libelle) <= 120)
        ...
        <h5 class="titre-2">{{ $service->libelle }}</h5>
    ...
    <div class="bg-certificate">
        @if ( strlen($service->libelle) <= 120)
            <img src="assets/images/attestation/congres/table-ronde-min.png" alt="" id="bg">
        @else
            <img src="assets/images/attestation/congres/table-ronde-max.png" alt="" id="bg">
        @endif
    </div>
</body>
