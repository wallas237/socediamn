...
<body>
    ...
    @elseif(strlen($service->libelle) >= 161 && strlen($service->libelle) <= 180)
    ...
    @elseif(strlen($service->libelle) >= 180 && strlen($service->libelle) <= 229)
    ...
    <div class="bg-certificate">
        ...
        <img src="assets/images/attestation/congres/rapporteur-symposium.png" alt="" id="bg">
    </div>
</body>
