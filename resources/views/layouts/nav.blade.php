<nav class="navbar p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
        @if (auth()->user()->login != '')
            <a class="navbar-brand brand-logo-mini" href="/welcome"><img src="assets/images/ico.png" alt="logo"
                    style="width: 50px; height: 20px;" /></a>
        @else
            <a class="navbar-brand brand-logo-mini" href="/dashboard"><img src="assets/images/ico.png" alt="logo"
                    style="width: 50px; height: 20px;" /></a>
        @endif
